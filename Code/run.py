...
sys.stdout = Logger("./logs/MGA_epoch_{}_loss_{}_alpah_{}_lr_{}_train_epoch_{}_emb_{}.txt".format(args.n_epoch, args.loss_type.split("_")[1], args.alpha, args.lr, args.train_epoch, args.n_inp))
